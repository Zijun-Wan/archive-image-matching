...
# IIIF image endpoint
IIIF_BASE = "https://www.e-rara.ch/i3f/v21/{record_id}/full/{size}/0/gray.jpg"
...
def get_all_page_ids_from_records(record_ids, max_workers=5, timeout=30, retries=3, save_json_path="dicts.json"):
    """
    ...
    with ThreadPoolExecutor(max_workers=max_workers) as executor:
        futures = futures = {executor.submit(get_all_page_ids, rec_id, timeout, retries): rec_id for rec_id in record_ids}
...
def main():
    ...
    parser.add_argument('--size', default='!600,600', help='Size parameter for IIIF (default: full)')
